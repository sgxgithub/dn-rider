...
<g:form action="validateSchema" method="post">
    <div class="form-group row">
        ...
        <div class="col-9">
            <textarea name='dn' id="textarea-dn" class="form-control" rows="30" cols="20">${dn}</textarea>
        </div>
        ...
        <div class="col-3">
            ...
            <g:link action="showSchema" class="btn btn-outline-primary mt-2" target="_blank">
